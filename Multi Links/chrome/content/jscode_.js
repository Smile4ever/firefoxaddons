...
//			MultiLinks_Wrapper.LinksManager.Select(gBrowser.contentDocument, MultiLinks_Wrapper.lastPX, MultiLinks_Wrapper.lastPY);
	...
	OnMouseMove: function(aEvent)
	{
		try
		{
			...
			MultiLinks_Wrapper.LinksManager.Select(parent, aEvent.pageX, aEvent.pageY);
			...
			var dH = 0;
			var dV = 0;
			if(MultiLinks_Wrapper.docVisibleHeight(doc) + MultiLinks_Wrapper.docScrollTop(doc) - aEvent.pageY < 5)
				dV = 1;
			if(aEvent.pageY - MultiLinks_Wrapper.docScrollTop(doc) < 5)
				dV = -1;
			if(MultiLinks_Wrapper.docVisibleWidth(doc) + MultiLinks_Wrapper.docScrollLeft(doc) - aEvent.pageX < 5)
				dH = 1;
			if(aEvent.pageX - MultiLinks_Wrapper.docScrollLeft(doc) < 5)
				dH = -1;
	...
	ScrollHold: function()
	{
		...
		MultiLinks_Wrapper.ScrollBy(gBrowser.contentDocument, MultiLinks_Wrapper.dHScroll * scsp, MultiLinks_Wrapper.dVScroll * scsp);
		MultiLinks_Wrapper.lastPX += MultiLinks_Wrapper.dHScroll * scsp;
		MultiLinks_Wrapper.lastPY += MultiLinks_Wrapper.dVScroll * scsp;
		MultiLinks_Wrapper.LinksManager.Select(gBrowser.contentDocument, MultiLinks_Wrapper.lastPX, MultiLinks_Wrapper.lastPY);
	},
